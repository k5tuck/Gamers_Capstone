...
function WidgetChat() {
  ...
  // const channel = useRef(channelWatch);

  // Method - Set the user with the strean chat client variable
  const setUser = useCallback(async () => {
    await client.setUser({ id, name }, client.devToken("istorms"));
  ...
  const setChannel = useCallback(async () => {
    // channel.current = client.channel("messaging", "gamers-members", {
