...
function SearchForm({SearchGame, SearchPost, setSearch, search, searchType, setSearchType }) {
    ...
    return (
        ...
        <form onSubmit={(e) => {
            ...
            <label>
                Post
            <input type="radio" value="Post" onChange={(e)=>{
            ...
            <label >
                Game
            <input type="radio" value="Game" onChange={(e)=>{
                setSearchType(e.target.value)
            }}/>
            </label>
            <br/>
